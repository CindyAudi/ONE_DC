...
| File | Description |
|---|---|
| `ONE_DC_Script.Rmd` | Main analysis script: clustering (Seurat), UMAP, marker gene identification, and inter-cluster correlation analysis |
...
Processed object / count matrices are available at 10.5281/zenodo.21093824.
